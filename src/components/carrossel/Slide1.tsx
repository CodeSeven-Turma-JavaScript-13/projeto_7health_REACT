...
import { RocketLaunchIcon, LeafIcon } from '@phosphor-icons/react';
...
function Slide1() {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative min-h-150 flex flex-col items-center justify-center overflow-hidden bg-[#1a3c1a] py-24 pb-32">
        ...
        <div className="absolute inset-0 z-0 opacity-10 pointer-events-none">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-125 h-125 border border-white rounded-full" />
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-175 h-175 border border-white/40 rounded-full" />
        </div>
